...
function Hero() {
  ...
  return (
<section id="top" className="relative overflow-hidden min-h-[100dvh]">      {/* Animated orbs */}
      ...
      <div className="relative mx-auto max-w-7xl px-3 sm:px-5">
        ...
        <<h1 className="reveal text-center font-display font-bold text-[clamp(28px,8vw,72px)] leading-[1.05] tracking-tight min-h-[160px] md:min-h-[220px]">
